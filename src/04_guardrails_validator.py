...
class PIIDetector(Validator):
    ...
    def validate(self, value: str, metadata: dict):
        ...
        if found_pii:
            ...
            # Trả về FailResult với fix_value=redacted_text để thay thế
            return FailResult(
...
class JSONFormatter(Validator):
    ...
    def validate(self, value: str, metadata: dict):
        ...
        Trả về FailResult với fix_value=JSON đã format nếu thành công.
        Trả về FailResult nếu JSON không thể sửa được.
        """
        # Thử parse JSON trực tiếp
        try:
            parsed = json.loads(value)
            # Trả về FailResult với fix_value=json.dumps(parsed, indent=2) để format lại
            return FailResult(
                error_message="JSON hợp lệ",
        ...
        try:
            ...
            # Trả về FailResult với fix_value để thay thế
            return FailResult(
